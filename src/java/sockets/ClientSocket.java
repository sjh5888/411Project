 ...
 * ClientSocket.java
 * Purpose: To accept a credit card number in string format
 * and establish a connection to the server "ServerSockets" 
 * for which the string will be passed to via a socket. 
 * Upon receiving a response back from ServerSockets, the results
 * will be sent back to the user to prompt success or failure.
 * 
...
public class ClientSocket {
     ...
     * it port number and a host name.
    ...
    /**
     *  requestService() defines this server's service, which consists
